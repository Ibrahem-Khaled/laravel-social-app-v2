              ...
              <div>
                  ...
                  <ul class="space-y-2">
                      <li class="flex items-start">
                          ...
                          <span class="text-gray-400">{{ $contactEmail ?? 'info@example.com' }}</span>
                      </li>
                      <li class="flex items-start">
                          <svg class="w-5 h-5 text-gray-400 mt-0.5 mr-2" fill="none" viewBox="0 0 24 24"
                              stroke="currentColor">
                          ...
                          <span class="text-gray-400">{{ $contactPhone ?? '+966 12 345 6789' }}</span>
                      </li>
                      <li class="flex items-start">
                          <svg class="w-5 h-5 text-gray-400 mt-0.5 mr-2" fill="none" viewBox="0 0 24 24"
                              stroke="currentColor">
                          ...
                          <span class="text-gray-400">{{ $contactAddress ?? 'الرياض، المملكة العربية السعودية' }}</span>
                      </li>
                  </ul>
              </div>
          </div>
          <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
              <p class="text-gray-400">© {{ date('Y') }} {{ env('APP_NAME') }}. جميع الحقوق محفوظة.</p>
